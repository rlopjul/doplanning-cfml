...
<cfcomponent displayname="Application" output="false">
	...
	<cffunction name="onApplicationStart" output="false" returntype="void" >
		...
		<cfset APPLICATION.bootstrapJSPath = "//netdna.bootstrapcdn.com/bootstrap/3.0.2/js/bootstrap.min.js">
		...
		<cfset APPLICATION.baseCSSPath = "//netdna.bootstrapcdn.com/bootstrap/3.0.2/css/bootstrap.min.css">
		<cfset APPLICATION.baseCSSIconsPath = "//netdna.bootstrapcdn.com/font-awesome/3.2.1/css/font-awesome.css">

		<cfset APPLICATION.themeCSSPath = "//netdna.bootstrapcdn.com/bootstrap/3.0.2/css/bootstrap-theme.min.css">
