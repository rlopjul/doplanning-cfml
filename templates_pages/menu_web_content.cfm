...
<div id="contenedor_menu">
	<div id="menu_superior">
		<ul class="pureCssMenu">
			...
			<cfoutput>
			<li id="menuinicio" <cfif GetFileFromPath(CGI.SCRIPT_NAME) EQ "index.cfm">class="apartadoActual"</cfif>><a href="../web/index.cfm">Inicio</a></li>
			<cfloop query="menuAreasQuery">
				...
				<cfset page_url_title = titleToUrl(menu_area_name)>
					...
					<ul class="menu_segundo_nivel">
						<cfloop query="menuSubAreasQuery">
							...
							<cfif menuSubSubAreasQuery.recordCount GT 0>	
								...
								<cfset subpage_url_title = titleToUrl(menuSubAreasQuery.name)>
								
								<li <cfif isDefined("area_id") AND (menuSubAreasQuery.id IS area_id)>class="subapartadoActual"</cfif>><a href="../web/page.cfm?id=#menuSubAreasQuery.id#&title=#subpage_url_title#"><span>#menuSubAreasQuery.name#</span><![if gt IE 6]></a><![endif]><!--[if lte IE 6]><table><tr><td><![endif]-->
								...
								<ul class="menu_tercer_nivel"><!---class="pureCssMenum"--->
									...
									<cfset subsubpage_url_title = titleToUrl(menuSubSubAreasQuery.name)>
									
									<li <cfif isDefined("area_id") AND menuSubSubAreasQuery.id IS area_id>class="subapartadoActual"</cfif>><a href="../web/page.cfm?id=#menuSubSubAreasQuery.id#&title=#subsubpage_url_title#">#menuSubSubAreasQuery.name#</a></li>
									</cfloop>
								</ul>
							...
							<cfelse>
								...
								<li <cfif isDefined("area_id") AND (menuSubAreasQuery.id IS area_id)>class="subapartadoActual"</cfif>><a href="../web/page.cfm?id=#menuSubAreasQuery.id#&title=#subpage_url_title#">#menuSubAreasQuery.name#</a></li>
							</cfif>
				...
				<cfelseif menuAreasQuery.id IS 500><!---Contacto--->
					<ul class="menu_segundo_nivel">
						<li><a href="../web/formulario_contacto.cfm">Formulario de contacto</a></li>
					</ul>
