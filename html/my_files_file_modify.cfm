...
<cfform action="#APPLICATION.htmlComponentsPath#/File.cfc?method=updateFile" method="post" class="form_preferences_user_data" name="file_form" onsubmit="return onSubmitForm();">
