...
Su comunicación ha sido registrada con el siguiente ID: <strong>#incidence_id#</strong><br/>
<!---En un plazo menor de 6 horas recibirá información sobre la incidencia comunicada
a través de su e-mail.<br/>--->
