...
<title>#APPLICATION.title#-Visualizar diagrama</title>
<!-- InstanceEndEditable -->
...
<cfoutput>
	<link rel="stylesheet" href="#APPLICATION.htmlPath#/scripts/joint/joint.nojquery.min.css" />
	<script src="#APPLICATION.htmlPath#/scripts/joint/joint.nojquery.min.js"></script>
</cfoutput>

<cfinclude template="#APPLICATION.htmlPath#/includes/diagram_view_content.cfm">
