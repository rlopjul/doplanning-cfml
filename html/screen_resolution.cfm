...
<div style="clear:both; padding-top:50px; padding-bottom:50px;" class="texto_normal">
Su resolución de pantalla es menor de 1024x768.<br/>
Para poder utilizar la aplicación DoPlanning debe tener una resolución igual o mayor a 1024x768.<br/>
Puede cambiar su resolución de pantalla y volver a acceder, o utilizar la versión HTML de la aplicación.<br /><br />

<a href="index.cfm" class="a_return">Utilizar la versión HTML</a>
</div>
