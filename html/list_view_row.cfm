...
<title>#APPLICATION.title#-Registro de vista</title>
<!-- InstanceEndEditable -->
...
<cfset itemTypeId = 14>
<cfinclude template="#APPLICATION.htmlPath#/includes/table_view_row_content.cfm">

<cfset return_page = "#itemTypeName#_rows.cfm?#itemTypeName#=#view_id#">
