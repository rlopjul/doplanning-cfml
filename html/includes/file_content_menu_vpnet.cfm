...
<div class="div_element_menu">
	<div class="div_icon_menus"><a href="#APPLICATION.htmlPath#/file_download.cfm?id=#objectFile.id#" onclick="return downloadFileLinked(this,event)"><img src="#APPLICATION.htmlPath#/assets/v3/icons/file_download.png" title="Descargar archivo" alt="Descargar archivo"/></a></div>
...
<cfif objectFile.user_in_charge EQ SESSION.user_id>
	<cfif page_type IS 1> 
		<div class="div_element_menu">
			<div class="div_icon_menus"><a href="file_associate_areas.cfm?file=#objectFile.id#&folder=#folder_id#"><img src="#APPLICATION.htmlPath#/assets/v3/icons/file_area.png" title="Asociar archivo a áreas" alt="Asociar archivo a áreas" /></a></div>
		...
		<div class="div_element_menu">
			<div class="div_icon_menus"><a href="my_files_file_replace.cfm?file=#objectFile.id#&folder=#folder_id#"><img src="#APPLICATION.htmlPath#/assets/v3/icons/file_replace.png" title="Reemplazar archivo" alt="Reemplazar archivo" /></a></div>
		...
		<div class="div_element_menu">
			<div class="div_icon_menus"><a href="my_files_file_modify.cfm?file=#objectFile.id#&folder=#folder_id#"><img src="#APPLICATION.htmlPath#/assets/v3/icons/file_modify.png" title="Modificar archivo" alt="Modificar archivo" /></a></div>
		...
		<div class="div_element_menu">
			<div class="div_icon_menus"><a href="#APPLICATION.htmlComponentsPath#/File.cfc?method=deleteFile&file_id=#objectFile.id#&folder_id=#folder_id#" onclick="return confirmDeleteFile();"><img src="#APPLICATION.htmlPath#/assets/v3/icons/file_delete.png" title="Eliminar archivo definitivamente" alt="Eliminar archivo" /></a></div>
	...
	<cfelseif page_type IS 2>
		...
		<div class="div_element_menu">
			<div class="div_icon_menus"><a href="file_copy.cfm?file=#objectFile.id#&area=#area_id#"><img src="#APPLICATION.htmlPath#/assets/v3/icons/file_copy.png" title="Copiar archivo a áreas" alt="Copiar archivo a áreas" /></a></div>
			<div class="div_text_menus"><a href="file_copy.cfm?file=#objectFile.id#&area=#area_id#" class="text_menus">Copiar<br />archivo</a></div>
		</div>--->
		
		<div class="div_element_menu">
			<div class="div_icon_menus"><a href="area_file_associate_areas.cfm?file=#objectFile.id#&area=#area_id#"><img src="#APPLICATION.htmlPath#/assets/v3/icons/file_area.png" title="Asociar archivo a otras áreas" alt="Asociar archivo a otras áreas" /></a></div>
		...
		<div class="div_element_menu">
			<div class="div_icon_menus"><a href="#APPLICATION.htmlComponentsPath#/File.cfc?method=dissociateFile&file_id=#objectFile.id#&area_id=#area_id#&return_path=#return_path#"><img src="#APPLICATION.htmlPath#/assets/v3/icons/file_delete.png" title="Quitar archivo del área" alt="Quitar archivo" /></a></div>
		...
		<cfif APPLICATION.identifier EQ "dp"><!---Solo para DoPlanning--->
			...
			<div class="div_element_menu">
				<div class="div_icon_menus"><a href="area_file_replace.cfm?file=#objectFile.id#&fileTypeId=#fileTypeId#&area=#area_id#"><img src="#APPLICATION.htmlPath#/assets/v3/icons/file_replace.png" title="Reemplazar archivo" alt="Reemplazar archivo" /></a></div>
			...
			<div class="div_element_menu">
				<div class="div_icon_menus"><a href="area_file_modify.cfm?file=#objectFile.id#&area=#area_id#"><img src="#APPLICATION.htmlPath#/assets/v3/icons/file_modify.png" title="Modificar archivo" alt="Modificar archivo" /></a></div>
...
<div class="div_element_menu">
	<cfif page_type IS 1>
	<div class="div_icon_menus"><a href="my_files_file_view.cfm?file=#objectFile.id#&folder=#folder_id#"><img src="#APPLICATION.htmlPath#/assets/v3/icons/file_view.png"/></a></div>
	...
	<cfelse>
	<div class="div_icon_menus"><a href="area_file_view.cfm?file=#objectFile.id#&area=#area_id#"><img src="#APPLICATION.htmlPath#/assets/v3/icons/file_view.png" title="Visualizar el archivo (imagen)"/></a></div>
