...
<cfif APPLICATION.publicationScope IS true AND isDefined("scope_id")>
	...
	<span class="help-block"><span lang="es">Ámbito de publicación definido:</span> #scope.name#</span>
</cfif>
<cfif noWebEnabled IS false AND webEnabled IS true>
	<span class="help-block" lang="es">Sólo puede seleccionar áreas web</span>
</cfif>
</div>
</cfoutput>
