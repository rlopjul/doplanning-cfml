...
<div class="div_element_menu">
	<div class="div_icon_menus"><a href="area_file_new.cfm?area=#area_id#"><img src="#APPLICATION.htmlPath#/assets/icons/file_new.png" alt="Subir nuevo archivo" title="Subir nuevo archivo" /></a></div>
		<div class="div_text_menus"><a href="area_file_new.cfm?area=#area_id#"> Nuevo<br/> archivo</a></div>
</div>
</cfif>
<div class="div_element_menu">
	<div class="div_icon_menus"><a href="file_associate.cfm?area=#area_id#"><img src="#APPLICATION.htmlPath#/assets/icons/file_area.png" alt="Asociar archivo al área" title="Asociar archivo al área" /></a></div>
