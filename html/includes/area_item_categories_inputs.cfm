		...
		<div class="row">
	        ...
	        <cfelseif isDefined("table.categories_ids") AND isArray(table.categories_ids)>
	          <cfset selectedAreasList = arrayToList(table.categories_ids)>
					...
					<p class="help-block" lang="es" style="margin-bottom:0">Estas categorías permiten a los usuarios clasificar los elementos y filtrar las notificaciones por email que se reciben</p>

				<cfelse>

					<p class="help-block" lang="es" style="margin-bottom:0">Este elemento tiene un área para categorías seleccionada pero esta área no tiene subareas para definir las categorías</p>
