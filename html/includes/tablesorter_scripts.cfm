<cfoutput>
<script src="#APPLICATION.path#/jquery/tablesorter/jquery.tablesorter.min.js?v=2.1"></script>
<script src="#APPLICATION.path#/jquery/tablesorter/jquery.tablesorter.widgets.min.js"></script>
<script src="#APPLICATION.path#/jquery/tablesorter/widgets/widget-math.js"></script>
