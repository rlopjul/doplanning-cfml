...
<script type="text/javascript">
	...
	function openAreaSelector(){
		...
		return openPopUp('#APPLICATION.htmlPath#/iframes/area_select.cfm?web_enabled=#webEnabled#&no_web_enabled=#noWebEnabled#&responsible_required=#responsibleRequired#&read_only=0');
