...
<cfelse>
	...
	<cfoutput>
	<form method="post" id="updateUserAlertPreferences"><!---class="form-horizontal"--->

		<input type="hidden" name="update_user_id" value="#preferences.user_id#"/>
...
userNotificationsDisabledQuery">
						<cfinvokeargument name="user_id" value="#preferences.user_id#">
						<cfinvokeargument name="client_abb" value="#SESSION.client_abb#">
								...
								<cfif subAreas.recordCount GT 0>
									...
									<div class="col-sm-6" style="padding-bottom:20px;">
										...
										<div class="row">
											...
											<label class="col-sm-2 control-label"><b lang="es">#itemTypesStruct[itemTypeId].labelPlural#</b><cfif itemTypeId IS 17> (Envíos masivos)</cfif></label>
