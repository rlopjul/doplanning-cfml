<cftry>
	...
	<cfcatch>
		...
		<!---<cfmail subject="Error en Doplanning" server="#APPLICATION.emailServer#" username="#APPLICATION.emailServerUserName#" password="#APPLICATION.emailServerPassword#" from="#APPLICATION.emailFrom#" failto="#APPLICATION.emailFail#" to="#APPLICATION.emailErrors#" type="html">
		<html><body>
