...
<cfcomponent output="false">
	...
	<cffunction name="outputArea" returntype="void" output="true" access="public">
		...
		<cfoutput>
		<li rel="#li_rel#<cfif arguments.admin IS true>-admin</cfif>" id="#areaId#" link="#area_with_link#" data-responsible="#NumberFormat(isUserAreaResponsible)#"<cfif arguments.root_node IS true> class="jstree-open"</cfif>>
