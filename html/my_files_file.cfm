...
<title>#APPLICATION.title#-Archivo</title>
<!-- InstanceEndEditable -->
...
<cfif isDefined("URL.folder")>
	<cfset return_page = "my_files.cfm?folder=#URL.folder#">
<cfelse>
	<cflocation url="my_files.cfm" addtoken="no">
</cfif>
<cfinclude template="includes/my_files_head.cfm">

<cfinclude template="includes/file_head.cfm">

<cfset page_type = 1>
<cfinclude template="includes/file_content.cfm">
