...
<title>#APPLICATION.title#-Modificar registro</title>
<!-- InstanceEndEditable -->
...
<cfset tableTypeId = 2>
<cfset page_type = 2>
<cfinclude template="#APPLICATION.htmlPath#/includes/table_row_form.cfm">

<!---<cfset return_page = "#tableTypeName#_row.cfm?#tableTypeName#=#table_id#&row=#row_id#">
