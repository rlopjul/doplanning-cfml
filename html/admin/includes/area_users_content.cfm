...
<div class="div_head_subtitle_area">
	...
	<a class="btn btn-info btn-small"><i class="icon-picture icon-white"></i> <span lang="es">Cambiar imagen</span></a><!---ESTO ESTÁ EMPEZADO PERO NO TERMINADO (falta solucionar lo de la subida de archivos) onclick="parent.loadModal('html_content/area_image_modify.cfm?area=#area_id#');" --->
