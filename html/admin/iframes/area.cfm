...
<p class="bg-info" style="margin:15px;padding:5px;"><!---text-info---><i class="icon-info-sign"></i>&nbsp;<span lang="es">Seleccione un área del árbol para ver sus usuarios.</span></p>
