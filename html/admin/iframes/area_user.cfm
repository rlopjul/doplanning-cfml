...
<div class="navbar navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container">
 			...
 			<a class="btn btn-warning btn-small" title="Quitar Usuario" onClick="return confirmAction('quitar');" href="user_delete.cfm?user=#user_id#" lange="es"><i class="icon-remove"></i> <span lang="es">Quitar de este area</span></a>
 			</cfif>
