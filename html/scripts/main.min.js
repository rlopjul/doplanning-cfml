...
}function showConfirmModal(c,a){var b={msg:c,error:false,confirm:true,callBackFunction:a};$("#alertModal").html(tmpl("tmpl-alert-modal",b));$("#alertModal").modal({width:650,backdrop:"static"});
return false;}function showAlertErrorModal(b){var a={msg:b,error:true};$("#alertModal").html(tmpl("tmpl-alert-modal",a));$("#alertModal").modal({width:650,backdrop:"static"});
