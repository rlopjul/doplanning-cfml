...
openUrl(b,d);hideDefaultModal();$("body").modalmanager("removeLoading");showAlertMessage(f,g.result);}else{alert(e);}}});}function postModalFormTree(b,a){$("body").modalmanager("loading");
