...
<cfinclude template="includes/incidences_head.cfm">

<cfset return_page = "incidences.cfm">
...
<cfform action="#APPLICATION.htmlComponentsPath#/Incidence.cfc?method=createIncidence" method="post" enctype="multipart/form-data">
	...
	<div class="div_subject_input"><span class="texto_normal">Tipo:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<cfselect name="type_id" query="incidences_types" value="id" display="title_es" multiple="no">
	</cfselect></div>
	<div class="div_subject_input"><span class="texto_normal">Referente a:</span>&nbsp;<cfselect name="related_to" multiple="no">
		<option value="Login">Login</option>
		<option value="Conectividad">Conectividad</option>
		<option value="Subida de archivos">Subida de archivos</option>
		<option value="Módulo de administración">Módulo de administración</option>
		<option value="Envío de emails">Envío de emails</option>
		<option value="Envío de SMSs">Envío de SMSs</option>
		<cfif APPLICATION.identifier EQ "dp">
	...
	<div class="div_subject_input"><span class="texto_normal">Asunto:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<cfinput type="text" name="title" class="input_message_subject" value="" required="true" message="Asunto requerido"></div>
    <div class="div_subject_input"><span class="texto_normal">Descripción detallada:</span></div>
	<div class="div_content_textarea">
	<textarea name="description" class="textarea_content"></textarea></div>
    
    <div class="input_submit"><cfinput type="submit" name="submit" class="input_message_submit" value="Enviar"></div>
</cfform>
</div>
