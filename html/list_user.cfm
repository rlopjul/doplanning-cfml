...
<title>#APPLICATION.title#-Usuario</title>
<!-- InstanceEndEditable -->
...
<cfset tableTypeId = 1>
<cfinclude template="#APPLICATION.htmlPath#/includes/table_user_menu.cfm">

<cfinclude template="#APPLICATION.htmlPath#/includes/user_content.cfm">

<cfset return_page = "#tableTypeName#_users.cfm?#tableTypeName#=#table_id#">
