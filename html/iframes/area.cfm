...
<cfif isDefined("URL.area")>
	<cfinclude template="../includes/area_content_iframe.cfm">
<cfelse>
	<div class="alert alert-info" style="margin:10px;"><i class="icon-info-sign"></i>&nbsp;<span lang="es">Seleccione un área del árbol para acceder a su contenido.</span></div>
</cfif>
<!-- InstanceEndEditable -->
</body>
<!-- InstanceEnd --></html>
