...
<title>#APPLICATION.title#-Mis documentos</title>
<!-- InstanceEndEditable -->
</cfoutput>
...
IMPORTANTE: el apartado de Mis Documentos ha cambiado.
</div>
<div class="div_alert_message_red" style="font-weight:normal;">
Desde aquí ya no se pueden crear nuevos documentos ni directorios, solo modificar los existentes.<br/>
A partir de ahora los documentos deben gestionarse en las áreas de la organización.<br/>
Ahora los nuevos documentos se pueden crear directamente en un área.
</div>
</cfif>

<cfinclude template="includes/my_files_menu.cfm">

<cfinclude template="includes/alert_message.cfm">

<cfset page_type = 1>
<cfinclude template="includes/my_files_content.cfm">
