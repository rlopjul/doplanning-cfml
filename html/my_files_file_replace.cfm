...
<script>
	...
	function openUrlHtml2(url,target){
		//En esta versi�n no se hace nada con las peticiones a este m�todo
	}
</script>
...
<cfoutput>
<cfform action="#APPLICATION.htmlPath#/my_files_replace_file.cfm?user_id=#SESSION.user_id#&client_abb=#SESSION.client_abb#&language=#SESSION.user_language#&session_id=#SESSION.SessionID#" method="post" enctype="multipart/form-data" onsubmit="return onSubmitForm();">
	<input type="hidden" name="file_id" value="#file_id#" />
	<input type="hidden" name="folder_id" value="#folder_id#" />

	<label>Archivo:</label>
	<cfinput type="file" name="Filedata" value="" style="width:100%; height:23px;" required="yes" message="Debe seleccionar un archivo"/>
