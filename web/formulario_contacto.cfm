...
<title>Formulario de contacto - ASNC</title>
<!-- InstanceEndEditable -->    
	...
	<div id="contenedor">
		<div id="header">
			...
			<div id="contenedor_navegacion">
				...
				<cfoutput>
				/ <a href="page.cfm?id=500">Contacto</a> / <a href="#CGI.SCRIPT_NAME#" class="actual">Formulario de contacto</a>
				</cfoutput>
		<!-- InstanceEndEditable -->
				</div><!--navegacion left-->
		...
		<div id="apartados_right">
			...
			<p class="title">Formulario de contacto</p><br />			
