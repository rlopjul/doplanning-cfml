...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es"><!-- InstanceBegin template="/Templates/web_home.dwt.cfm" codeOutsideHTMLIsLocked="false" -->
<head>
<cfsilent>
	...
	<div id="contenedor">
		<div id="header">
			...
			<div id="contenedor_navegacion">
				...
				<cfif len(getAuthUser()) GT 0 AND getFileFromPath(CGI.SCRIPT_NAME) NEQ "index.cfm"> 
				<cfoutput>
		...
		<div id="home_center">
		<!-- InstanceBeginEditable name="titulo_home" -->
		<h1 class="title">Bienvenidos al Área Sanitaria Norte de Córdoba</h1><br />
		<!-- InstanceEndEditable -->
		<img src="../assets/anim_home.jpg" alt="ASNC" title="ASNC" />
		<!-- InstanceBeginEditable name="contenido_home" -->
		<p>Este portal nace con el objetivo de ser tanto una fuente de información como una herramienta de trabajo que facilite la comunicación y colaboración entre profesionales, pacientes y ciudadanía en general.</p><br/>

<p>Las características del Área de Gestión Sanitaria Norte de Córdoba, que presta servicios tanto de atención primaria como hospitalaria, en un territorio amplio y disperso (Valle de Los Pedroches y Guadiato) requería de una herramienta como ésta en la que se ofrezca información útil y actualizada además de facilitar el trabajo y la comunicación a través de entornos colaborativos y abrir nuevos espacios de relación entre ciudadanos y profesionales.</p><br/>

<p>Sin más, solo darle la bienvenida, agradecerle que nos visite y animarle a que participe.</p>

<p style="font-style:italic; text-align:right;">Arturo E. Domínguez Fernández<br/>

Gerente del Área sanitaria Norte de córdoba.
		</p><br />
