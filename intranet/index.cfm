...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es"><!-- InstanceBegin template="/Templates/intranet_home.dwt.cfm" codeOutsideHTMLIsLocked="false" -->
<head>
<cfsilent>
		...
		<div id="home_left_intranet">
			...
			<div class="box_border_content_intranet">
				<ul class="lista_box">
					...
					<li><a href="download_file.cfm?file=#filesQuery.id#&area=#filesQuery.area_id#" class="link">#filesQuery.name#</a></li>
					</cfloop>
				</ul>
