...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es"><!-- InstanceBegin template="/Templates/intranet_apartados.dwt.cfm" codeOutsideHTMLIsLocked="false" -->
<head>
<cfsilent>
...
<title>Mapa Web - Intranet ASNC</title>
<!-- InstanceEndEditable -->    
	...
	<div id="contenedor">
								...
								<li><a href="page.cfm?id=#subAreasQuery.id#">#subAreasQuery.name#</a>
									...
									<cfif subSubAreasQuery.recordCount GT 0>
										...
										<cfloop query="subSubAreasQuery"><!---SUBSUBAPARTADOS--->
											<li><a href="page.cfm?id=#subSubAreasQuery.id#">#subSubAreasQuery.name#</a></li>
										</cfloop>
										</ul>
									</cfif>
		...
		<div id="contenedor_footer">
			...
			<div id="footer">
				...
				<div id="footer_right">
					<a href="mapa_web.cfm">Mapa web</a> | <a href="../web/terminos_de_uso.cfm" target="_blank">Términos de uso</a>
