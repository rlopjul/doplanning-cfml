...
<title>Eventos anteriores - Intranet ASNC</title>
<!-- InstanceEndEditable -->    
	...
	<div id="contenedor">
		<div id="header_intranet">
			...
			<div id="contenedor_navegacion">
				...
				<cfoutput>
				/ <a href="#CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#" class="actual">Eventos anteriores</a>
				</cfoutput>
		<!-- InstanceEndEditable -->
				</div><!--navegacion left-->
		...
		<div id="apartados_right">
			...
			<p class="title">Eventos anteriores</p><br />			
			
			<cfinclude template="../templates_pages/list_events.cfm">
