...
<title>Noticias anteriores - Intranet ASNC</title>
<!-- InstanceEndEditable -->    

<script type="text/javascript" src="../Scripts/functions.js"></script>
<!-- InstanceBeginEditable name="head" -->
<cfinclude template="../templates_pages/page_query.cfm">
<!-- InstanceEndEditable -->
	...
	<div id="contenedor">
		<div id="header_intranet">
			...
			<div id="contenedor_navegacion">
				...
				<cfoutput>
				/ <a href="#CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#" class="actual">Noticias anteriores</a>
				</cfoutput>
		<!-- InstanceEndEditable -->
				</div><!--navegacion left-->
		...
		<div id="apartados_right">
			...
			<p class="title">Noticias anteriores</p><br />			
			
			<cfinclude template="../templates_pages/list_news.cfm">
