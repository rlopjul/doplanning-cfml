...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','960','height','87','title','presentacion','src','../assets/presentacion_dp_cabecera_home','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','../assets/presentacion_dp_cabecera_home' ); //end AC code
    ...
    <div id="wrapper">
		...
		<div class="tutorial_path_div">Ayuda </div>
		
		
		<div class="tutorial_list_text">Video turoriales de DoPlanning:</div>
		
		<cfset language = "es">		
		<cfquery datasource="#APPLICATION.dsn#" name="getTutorials">
			SELECT *, title_#language# AS title
			FROM APP_tutorials
		...
		<cfoutput>
		<cfloop query="getTutorials">
			<cfif isValid("integer",getTutorials.level)>
				<cfset margin_val = margin*getTutorials.level>
			<cfelse>
				<cfset margin_val = 0>
			</cfif>
			<div class="tutorial_list_title_div" style="margin-left:#margin_val#px">
			<img class="bullet" src="../assets/bullet.png" alt="bullet" /><a href="tutorial.cfm?tid=#getTutorials.id#" class="tutorial_list_title">#title#</a></div>
		</cfloop>
		</cfoutput>
		</div>
