...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/tutorials_doplanning.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
<cfif isDefined("URL.tid")>
	<cfset tutorial_id = URL.tid>
<cfelse>
	<cflocation url="index.cfm" addtoken="no">
</cfif>

<cfset language = "es">	
<cfquery datasource="#APPLICATION.dsn#" name="getTutorial">
	SELECT *, title_#language# AS title, description_#language# AS description, goal_#language# AS goal, how_to_#language# AS how_to, link_#language# AS link
	FROM APP_tutorials
	WHERE id = <cfqueryparam value="#tutorial_id#" cfsqltype="cf_sql_integer">;
</cfquery>
<cfoutput>
<title>DoPlanning - #getTutorial.title#</title>
</cfoutput>
<!-- InstanceEndEditable -->
...
{
var windowOptions=("toolbar=no,location=no, directories=no, status=no, menubar=no ,scrollbars=no, resizable=no, fullscreen=yes"); 
window.open(page,"",windowOptions);
}
</script>
<!-- InstanceEndEditable -->
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','960','height','87','title','presentacion','src','../assets/presentacion_dp_cabecera_home','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','../assets/presentacion_dp_cabecera_home' ); //end AC code
    ...
    <div id="wrapper">
		...
		<a href="tutorials.cfm" class="enlace_apartado">Tutoriales</a>
		...
		<!-- InstanceBeginEditable name="contenido" -->
				<div style="float:right; padding:5px;"><a href="/web/terms_of_use.cfm" class="enlace_volver" target="_blank">Términos de uso</a></div>
		<cfoutput>
		<div class="tutorial_path_div"><a href="index.cfm" class="tutorial_path">Ayuda</a> > #getTutorial.title#</div>
		
			<div class="tutorial_container">
				
				<!---<div class="tutorial_title">#getTutorial.title#</div>--->
				
				<div class="tutorial_element">Qué es</div><div class="tutorial_description">#getTutorial.description#</div>
				
				<div class="tutorial_element">Para qué sirve</div><div class="tutorial_goal">#getTutorial.goal#</div>
				
				<div class="tutorial_element">Cómo hacerlo</div><div class="tutorial_how_to">#getTutorial.how_to#</div>
				
				<cfif len(getTutorial.link) GT 0>
				<div class="tutorial_link_div"><a href="javascript:openFullScreen('#getTutorial.link#')" class="tutorial_link">| VIDEO |</a></div>
				</cfif>
			</div>
		</cfoutput>
		
		
		<div style="padding:20px;"><a href="tutorials.cfm" class="enlace_volver">Volver <img src="../assets/volver.png"  class="volver" border="0" alt="Volver" title="Volver" /></a> </div>
