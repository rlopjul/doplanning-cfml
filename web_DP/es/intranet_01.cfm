...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/que_es_doplanning.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','960','height','87','title','presentacion','src','../assets/presentacion_dp_cabecera_home','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','../assets/presentacion_dp_cabecera_home' ); //end AC code
    ...
    <div id="wrapper">
		...
		<a href="que_es.cfm" class="enlace_apartado">¿Qué es DoPlanning?</a>
        ...
        <ul class="primernivel">
            	<li id="organizaciones.cfm">
          			<img src="../assets/cuadrado_verde.png"/>&nbsp;
                <a class="enlace_menuv" href="organizaciones.cfm">Gestor de organizaciones</a>
                </li>
                
                <li id="equipos_trabajo.cfm">
                <img src="../assets/cuadrado_azul.png"/>&nbsp;
                <a class="enlace_menuv" href="equipos_trabajo.cfm">Gestor de equipos de trabajo </a>
  
                </li>
                
                <li id="sencillo.cfm">
                <img src="../assets/cuadrado_rojo.png"/>&nbsp;
                <a class="enlace_menuv" href="sencillo.cfm">Gestor sencillo de proyectos </a>                </li>
                
                <li id="documental.cfm">
                <img src="../assets/cuadrado_verde.png"/>&nbsp;
                <a class="enlace_menuv" href="documental.cfm">Gestor documental </a>

                </li>
				<li id="intranet.cfm">
                <img src="../assets/cuadrado_azul.png"/>&nbsp;
                <a class="enlace_menuv" href="intranet.cfm">Gestor de intranet </a>
		...
		<div class="contenido_marco">
		              ...
		              <p class="resaltar_rojo">Potente Intranet</p>
		              <p>&nbsp;</p>
		              <p class="slogan"><br />
		                Si ya tiene una web y le gustaría tener una Intranet que usted administre con facilidad y flexibilidad........</p>
		              <p>&nbsp;</p>
		              <p class="slogan">.......... DoPlanning puede ser la solución.... y la solución económica ! </p>
		              <p>&nbsp;</p>
		              <p>&nbsp;</p>
		              <p>Con DoPlanning puede tener una Intranet en la que autorice a diferentes usuarios a acceder a diferentes documentos. </p>
		              <p>&nbsp;</p>
		              <p><br />
	                 <ul class="lista_contenidos"><li>Se puede integrar la ventana de acceso a DoPlanning dentro de la Web de la Organización.</li></p>
		              <p><br />
	                  <li>Permite tener una Internet potente y completa sin necesidad de disponer de servidores ni bases de datos propios.</li></p>
		              <p><br />
	                <li>  Se dispone inmediatamente de las funcionalidades clásicas de una Intranet :</li></p>
		              <blockquote>
		                <blockquote>
		                  <blockquote>
		                    <p><br />
	                    <ul class="sublista_contenidos">
	                       <li>    	Gestión de permisos para acceder a contenidos.</li></p>
		                    <p><br />
	                    <li>    Documentos para descarga gestionados por áreas.</li></p>
		                    <p><br />
	                    <li>    Foros por áreas  con acceso restringido a los usuarios de cada área.</li></ul></p>
		                    <p><br />
		               <li>       A diferencia de otras aplicaciones DoPlanning es una aplicación en alquiler en la que el coste depende del consumo en términos de número de usuarios, espacio en disco y transferencia.</li></ul><br />
	                        </p>
