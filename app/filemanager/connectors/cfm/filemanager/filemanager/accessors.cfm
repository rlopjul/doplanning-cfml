...
<cffunction name="$getRoot" access="private" output="false" returntype="string">
	...
	<!---<cfargument name="baseTemplatePath" type="string" required="false" default="/webroot/hosts/doplanning.net/ROOT" />--->
	
	<cfargument name="baseTemplatePath" type="string" required="false" default="#left(ExpandPath('/'),len(ExpandPath('/'))-1)#" />
