<cfset version_id = "3.10">

<cfif checkVersion IS true>

	<cfquery datasource="#client_datasource#" name="isDbDp310">
		SELECT *
		FROM information_schema.COLUMNS
		WHERE TABLE_SCHEMA = 'dp_#new_client_abb#'
		AND TABLE_NAME = '#new_client_abb#_users_typologies'
...
<cfif checkVersion IS true AND isDbDp310.recordCount GT 0>
...
<cfelse>
	...
	<cftry>
		...
		<cfquery datasource="#client_datasource#">
			ALTER TABLE `dp_#new_client_abb#`.`#new_client_abb#_users_typologies` ADD COLUMN `publication_scope_id` INTEGER UNSIGNED DEFAULT NULL AFTER `general`;
		</cfquery>

		<cfquery datasource="#client_datasource#">
			ALTER TABLE `dp_#new_client_abb#`.`#new_client_abb#_users_typologies` ADD CONSTRAINT `FK_#new_client_abb#_users_typologies_6` FOREIGN KEY `FK_#new_client_abb#_users_typologies_6` (`publication_scope_id`)
		...
		<cfquery datasource="#client_datasource#">
			 ALTER TABLE `dp_#new_client_abb#`.`#new_client_abb#_users_typologies` ADD COLUMN `publication_date` DATE AFTER `publication_scope_id`,
