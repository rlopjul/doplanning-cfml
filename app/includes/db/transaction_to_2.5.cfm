...
<cftransaction>
	...
	<cfquery datasource="#client_datasource#">	
		CREATE TABLE `#new_client_abb#_items_position` (
		  ...
		  KEY `FK_#new_client_abb#_items_position_1` (`area_id`),
	...
	<cfquery datasource="#client_datasource#">	
		CREATE TABLE  `#new_client_abb#_lists` (
		  ...
		  KEY `FK_#new_client_abb#_lists_1` (`user_in_charge`),
		  KEY `FK_#new_client_abb#_lists_2` (`area_id`),
		  KEY `FK_#new_client_abb#_lists_3` (`attached_file_id`),
		  KEY `FK_#new_client_abb#_lists_4` (`attached_image_id`),
		  CONSTRAINT `FK_#new_client_abb#_lists_1` FOREIGN KEY (`user_in_charge`) REFERENCES `#new_client_abb#_users` (`id`),
		  CONSTRAINT `FK_#new_client_abb#_lists_2` FOREIGN KEY (`area_id`) REFERENCES `#new_client_abb#_areas` (`id`),
	...
	<cfquery datasource="#client_datasource#">	
		CREATE TABLE  `#new_client_abb#_lists_fields` (
		  ...
		  KEY `FK_#new_client_abb#_lists_fields_1` (`field_type_id`),
		  KEY `FK_#new_client_abb#_lists_fields_2` (`table_id`),
	...
	<cfquery datasource="#client_datasource#">	
		CREATE TABLE  `#new_client_abb#_forms` (
		  ...
		  `general` tinyint(1) NOT NULL DEFAULT '0',
		  PRIMARY KEY (`id`) USING BTREE,
		  KEY `FK_#new_client_abb#_forms_1` (`user_in_charge`),
		  KEY `FK_#new_client_abb#_forms_2` (`area_id`),
		  KEY `FK_#new_client_abb#_forms_3` (`attached_file_id`),
		  KEY `FK_#new_client_abb#_forms_4` (`attached_image_id`),
		  CONSTRAINT `FK_#new_client_abb#_forms_1` FOREIGN KEY (`user_in_charge`) REFERENCES `#new_client_abb#_users` (`id`),
		  CONSTRAINT `FK_#new_client_abb#_forms_2` FOREIGN KEY (`area_id`) REFERENCES `#new_client_abb#_areas` (`id`),
	...
	<cfquery datasource="#client_datasource#">	
		CREATE TABLE  `#new_client_abb#_forms_fields` (
		  ...
		  `default_value` varchar(1000) DEFAULT NULL,
		  PRIMARY KEY (`field_id`),
		  KEY `FK_#new_client_abb#_forms_fields_1` (`field_type_id`),
		  KEY `FK_#new_client_abb#_forms_fields_2` (`table_id`),
	...
	<cfquery datasource="#client_datasource#">	
		CREATE TABLE  `#new_client_abb#_typologies` (
		  ...
		  `general` tinyint(1) NOT NULL DEFAULT '0',
		  PRIMARY KEY (`id`) USING BTREE,
		  KEY `FK_#new_client_abb#_typologies_1` (`user_in_charge`),
		  KEY `FK_#new_client_abb#_typologies_2` (`area_id`),
		  KEY `FK_#new_client_abb#_typologies_3` (`attached_file_id`),
		  KEY `FK_#new_client_abb#_typologies_4` (`attached_image_id`),
		  CONSTRAINT `FK_#new_client_abb#_typologies_1` FOREIGN KEY (`user_in_charge`) REFERENCES `#new_client_abb#_users` (`id`),
		  CONSTRAINT `FK_#new_client_abb#_typologies_2` FOREIGN KEY (`area_id`) REFERENCES `#new_client_abb#_areas` (`id`),
	...
	<cfquery datasource="#client_datasource#">	
		CREATE TABLE  `#new_client_abb#_typologies_fields` (
		  ...
		  `default_value` varchar(1000) DEFAULT NULL,
		  PRIMARY KEY (`field_id`),
		  KEY `FK_#new_client_abb#_typologies_fields_1` (`field_type_id`),
		  KEY `FK_#new_client_abb#_typologies_fields_2` (`table_id`),
	...
	<cfquery datasource="#client_datasource#">	
		CREATE TABLE  `#new_client_abb#_images` (
		  ...
		  KEY `area_id` (`area_id`),
		  KEY `FK_#new_client_abb#_images_4` (`attached_image_id`),
		  KEY `FK_#new_client_abb#_images_5` (`display_type_id`),
		  CONSTRAINT `FK_#new_client_abb#_images_1` FOREIGN KEY (`user_in_charge`) REFERENCES `#new_client_abb#_users` (`id`),
		  CONSTRAINT `FK_#new_client_abb#_images_2` FOREIGN KEY (`attached_file_id`) REFERENCES `#new_client_abb#_files` (`id`),
		  CONSTRAINT `FK_#new_client_abb#_images_3` FOREIGN KEY (`area_id`) REFERENCES `#new_client_abb#_areas` (`id`),
	...
	<cfquery datasource="#client_datasource#">	
		CREATE TABLE  `#new_client_abb#_pubmeds` (
		  ...
		  KEY `attached_file_id` (`attached_file_id`),
		  KEY `area_id` (`area_id`),
		  KEY `FK_#new_client_abb#_pubmeds_4` (`attached_image_id`),
		  KEY `FK_#new_client_abb#_pubmeds_5` (`display_type_id`),
		  CONSTRAINT `FK_#new_client_abb#_pubmeds_5` FOREIGN KEY (`display_type_id`) REFERENCES `#new_client_abb#_display_types` (`display_type_id`),
		  CONSTRAINT `FK_#new_client_abb#_pubmeds_1` FOREIGN KEY (`user_in_charge`) REFERENCES `#new_client_abb#_users` (`id`),
		  CONSTRAINT `FK_#new_client_abb#_pubmeds_2` FOREIGN KEY (`attached_file_id`) REFERENCES `#new_client_abb#_files` (`id`),
	...
	<cfquery datasource="#client_datasource#">	
		CREATE TABLE  `#new_client_abb#_lists_users` (
		  ...
		  KEY `FK_#new_client_abb#_lists_users_2` (`user_id`),
	...
	<cfquery datasource="#client_datasource#">	
		CREATE TABLE  `#new_client_abb#_lists_rows_areas` (
		  ...
		  KEY `FK_#new_client_abb#_lists_rows_areas_2` (`field_id`),
		  KEY `FK_#new_client_abb#_lists_rows_areas_3` (`area_id`),
		  CONSTRAINT `FK_#new_client_abb#_lists_rows_areas_1` FOREIGN KEY (`list_id`) REFERENCES `#new_client_abb#_lists` (`id`) ON DELETE CASCADE,
	...
	<cfquery datasource="#client_datasource#">	
		CREATE TABLE  `#new_client_abb#_typologies_rows_areas` (
		  ...
		  KEY `FK_#new_client_abb#_typologies_rows_areas_2` (`field_id`),
		  KEY `FK_#new_client_abb#_typologies_rows_areas_3` (`area_id`),
		  CONSTRAINT `FK_#new_client_abb#_typologies_rows_areas_1` FOREIGN KEY (`typology_id`) REFERENCES `#new_client_abb#_typologies` (`id`) ON DELETE CASCADE,
	...
	<cfquery datasource="#client_datasource#">	
		CREATE TABLE  `#new_client_abb#_forms_rows_areas` (
		  ...
		  KEY `FK_#new_client_abb#_forms_rows_areas_2` (`field_id`),
		  KEY `FK_#new_client_abb#_forms_rows_areas_3` (`area_id`),
		  CONSTRAINT `FK_#new_client_abb#_forms_rows_areas_1` FOREIGN KEY (`form_id`) REFERENCES `#new_client_abb#_forms` (`id`) ON DELETE CASCADE,
	...
	<cfquery datasource="#client_datasource#">	
		CREATE TABLE  `#new_client_abb#_files_locks` (
		  ...
		  KEY `FK_#new_client_abb#_files_locks_2` (`user_id`),
		  CONSTRAINT `FK_#new_client_abb#_files_locks_1` FOREIGN KEY (`file_id`) REFERENCES `#new_client_abb#_files` (`id`) ON DELETE CASCADE,
	...
	<cfquery datasource="#client_datasource#">	
		ALTER TABLE `#new_client_abb#_files` ADD COLUMN `reviser_user` INTEGER AFTER `locked`,
			 ...
			 ADD CONSTRAINT `FK_#new_client_abb#_files_3` FOREIGN KEY `FK_#new_client_abb#_files_3` (`reviser_user`)
				...
				ON DELETE RESTRICT
				ON UPDATE RESTRICT,
			 ADD CONSTRAINT `FK_#new_client_abb#_files_4` FOREIGN KEY `FK_#new_client_abb#_files_4` (`approver_user`)
				REFERENCES `#new_client_abb#_users` (`id`)
				ON DELETE RESTRICT
				ON UPDATE RESTRICT;
	</cfquery>	
	...
	<cfquery datasource="#client_datasource#">	
		CREATE TABLE  `#new_client_abb#_files_versions` (
		  ...
		  KEY `FK_#new_client_abb#_files_versions_3` (`revision_request_user`),
		  KEY `FK_#new_client_abb#_files_versions_4` (`revision_user`),
		  KEY `FK_#new_client_abb#_files_versions_5` (`approval_user`),
		  KEY `FK_#new_client_abb#_files_versions_6` (`publication_user`),
		  ...
		  CONSTRAINT `FK_#new_client_abb#_files_versions_4` FOREIGN KEY (`revision_user`) REFERENCES `#new_client_abb#_users` (`id`),
		  CONSTRAINT `FK_#new_client_abb#_files_versions_5` FOREIGN KEY (`approval_user`) REFERENCES `#new_client_abb#_users` (`id`),
	...
	<cfquery datasource="#client_datasource#">	
		CREATE TABLE  `#new_client_abb#_lists_views` (
		  ...
		  PRIMARY KEY (`id`) USING BTREE,
		  KEY `FK_#new_client_abb#_lists_views_1` (`table_id`),
		  KEY `FK_#new_client_abb#_lists_views_2` (`user_in_charge`),
		  KEY `FK_#new_client_abb#_lists_views_3` (`area_id`),
		  CONSTRAINT `FK_#new_client_abb#_lists_views_1` FOREIGN KEY (`table_id`) REFERENCES `#new_client_abb#_lists` (`id`),
	...
	<cfquery datasource="#client_datasource#">	
		CREATE TABLE  `#new_client_abb#_forms_views` (
		  ...
		  `update_user_position` int(10) unsigned NOT NULL,
		  PRIMARY KEY (`id`) USING BTREE,
		  KEY `FK_#new_client_abb#_forms_views_1` (`table_id`),
		  KEY `FK_#new_client_abb#_forms_views_2` (`user_in_charge`),
		  KEY `FK_#new_client_abb#_forms_views_3` (`area_id`),
