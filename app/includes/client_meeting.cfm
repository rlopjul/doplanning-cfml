<cftry>
	...
	<cfif NOT isDefined("URL.type") OR NOT isNumeric(URL.type) OR NOT isDefined("URL.area") OR NOT isNumeric(URL.area)>
		<cflocation url="index.cfm" addtoken="no">
	</cfif>
	
	<cfif URL.type IS 1>
		<cfset swf_name = "Livera7DPPresentation">
	<cfelseif URL.type IS 2>
		<cfset swf_name = "Livera7DPMeeting">
	<cfelseif URL.type IS 3>
		<cfset swf_name = "Livera7DP">
	</cfif>
