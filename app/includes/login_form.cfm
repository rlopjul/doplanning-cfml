<cfoutput>
  ...
  <form id="login_form" action="#CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#" method="post" onsubmit="return codificarForm(this)" class="form-horizontal">
    ...
    <div class="control-group">    
      <label for="email" lang="es" class="control-label"><cfif APPLICATION.moduleLdapUsers NEQ true>Email:<cfelse><!--- LDAP --->Usuario:</cfif></label>
      <div class="controls">
        <cfif APPLICATION.moduleLdapUsers NEQ true>
        <input name="email" type="email" id="email" required="true" autofocus="true"/>
        <cfelse><!--- LDAP --->
        <input name="email" type="text" id="email" required="true" autofocus="true"/>
        </cfif>
      </div>
    </div>
    
    <div class="control-group">
      <label for="password" lang="es" class="control-label">Contraseña:</label>
      <div class="controls">
    ...
    <div class="control-group">
        <div class="controls">
          ...
          <cfif APPLICATION.identifier EQ "dp">
            <a href="remember_password.cfm?client_abb=#client_abb#" title="¿Olvidó su contraseña?" lang="es"><button type="button" class="btn">Resetear contraseña</button></a>
          </cfif>
        </div>
    </div>
</form>
