...
<cftry>			
	...
	<cfif isDefined("URL.user_id") AND isDefined("URL.client_abb") AND isDefined("URL.language") AND isDefined("URL.session_id") AND isDefined("URL.folder_id")>
