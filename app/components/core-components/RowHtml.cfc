					...
					<thead>
						<tr #thTrStyle#>
							...
							<cfloop query="fields">
								...
								<cfelse>
									<th #thStyle# <cfif fields.field_type_id IS 7 OR fields.filter_by_select><!---Boolean OR filter_by_select--->class="filter-select" data-placeholder="#fields.label#"</cfif>>#fields.label#</th>
								</cfif>
