...
<!---typologies (files)--->
<cfset structInsert(tableTypesStruct, 3, {id=3, position=3, name="typology", namePlural="typologies", table="typologies", label="Tipología", labelPlural="Tipologías", gender="female", itemTypeId=13, viewTypeId=0})>

<!---typologies (users)--->
<cfset structInsert(tableTypesStruct, 4, {id=4, position=4, name="user_typology", namePlural="users_typologies", table="users_typologies", label="Tipología de usuario", labelPlural="Tipologías de usuarios", gender="female", itemTypeId=16, viewTypeId=0})>
