...
<cfcomponent output="false">
	...
	<cffunction name="generateSearchText" access="public" output="false" returntype="string">
		...
		<cfargument name="removeSpecialChars" type="boolean" defaul="true">
		<cfargument name="replaceVowels" type="boolean" default="true">
		...
		<cfif arguments.replaceVowels IS true>
