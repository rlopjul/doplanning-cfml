...
<cfcomponent output="false">
	...
	(1, '¡Bienvenido a #APPLICATION.title#!', ADDDATE(<cfqueryparam value="#current_date#" cfsqltype="cf_sql_timestamp">,3));
			...
			<cfinclude template="#APPLICATION.resourcesPath#/includes/db/transaction_to_3.2.2.cfm">

			<cfinclude template="#APPLICATION.resourcesPath#/includes/db/transaction_to_3.3.cfm">

			<cfinclude template="#APPLICATION.resourcesPath#/includes/db/transaction_to_3.3.1.cfm">
			...
			<cfinclude template="#APPLICATION.resourcesPath#/includes/db/transaction_to_3.6.cfm">

			<cfinclude template="#APPLICATION.resourcesPath#/includes/db/transaction_to_3.7.cfm">

			<cfinclude template="#APPLICATION.resourcesPath#/includes/db/transaction_to_3.8.cfm">

			<cfinclude template="#APPLICATION.resourcesPath#/includes/db/transaction_to_3.9.cfm">

			<cfinclude template="#APPLICATION.resourcesPath#/includes/db/transaction_to_3.10.cfm">

			<cfinclude template="#APPLICATION.resourcesPath#/includes/db/transaction_to_3.11.cfm">			
