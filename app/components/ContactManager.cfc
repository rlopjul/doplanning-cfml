...
<cfset var xmlResponseContent = "">
	...
	<!--- ------------------------ SELECT USER CONTACT ------------------------------------ --->
	<cffunction name="selectContact" returntype="string" output="true" access="public">
...
<cfset var xmlResponseContent = "">
	...
	<cffunction name="deleteContact" returntype="string" output="false" access="public">
		<cfargument name="request" type="string" required="yes">
...
<cfset var xmlResponseContent = "">
	...
	<cffunction name="createContact" returntype="string" output="false" access="public">
		<cfargument name="request" type="string" required="yes">
...
<cfset var xmlResponseContent = "">
	...
	<!--- ++++++++++++++++++++++++++++ UPDATE USER CONTACT ++++++++++++++++++++++++++++++++ --->
	<cffunction name="updateContact" returntype="string" output="false" access="public">
		<cfargument name="request" type="string" required="yes">
