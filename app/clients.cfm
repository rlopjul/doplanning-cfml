...
OR SESSION.user_id EQ "93" OR SESSION.user_id EQ "152" OR SESSION.user_id EQ "1")) OR (SESSION.client_abb EQ "web4bio7" AND SESSION.user_id EQ "4") OR (SESSION.client_abb EQ "software7" AND SESSION.user_id EQ "2") OR (APPLICATION.identifier EQ "vpnet" AND SESSION.user_id IS 1)>
