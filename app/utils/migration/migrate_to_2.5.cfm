<cfif (SESSION.client_abb EQ "doplanning" AND SESSION.user_id IS 1) OR (SESSION.client_abb EQ "software7" AND SESSION.user_id IS 2)>
	...
	<cfif isDefined("FORM.abb")>	
		...
		<cfinclude template="transaction_to_2.5.cfm">	
	...
	<cfelseif isDefined("FORM.migrate")>
		...
		<cfloop query="getClients">
			...
			<cfquery datasource="#client_dsn#" name="isDbDp21">
				SHOW TABLES LIKE '#client_abb#_items_position';
			</cfquery>
