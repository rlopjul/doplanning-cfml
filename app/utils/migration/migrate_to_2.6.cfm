<!---<cfif (SESSION.client_abb EQ "doplanning" AND SESSION.user_id IS 1)>--->
	...
	<title>Migrar Clientes 2.6</title>
	</head>
	...
	<cfif isDefined("FORM.abb")>	
		...
		<cfinclude template="transaction_to_2.6.cfm">	
	...
	<cfelseif isDefined("FORM.migrate")>
		...
		<cfloop query="getClients">
			...
			<cfquery datasource="#client_dsn#" name="isDbDp26">
				SHOW TABLES LIKE '#client_abb#_scopes';
			</cfquery>
	
			<cfif isDbDp26.recordCount IS 0>
				<cfoutput>
					Migrar #client_abb#
				</cfoutput>
