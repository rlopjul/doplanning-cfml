<!---Copyright Era7 Information Technologies 2007-2009
	...
	Date of file creation: 09-03-2009
...
<cfcomponent output="false">
	...
	<cffunction name="loginLDAPUser" returntype="string" output="false" access="public">
		...
		<cfset var loginValid = false>
			...
			<cfif arguments.ldap_id IS "default"><!---Default LDAP--->
			...
			<cfelse>
				...
				<cftry>
					<cfldap	server="10.75.2.64" username="#user_login#@diraya" password="#password_ldap#" action="query" name="getUser" start="dc=diraya.sspa.junta-andalucia.es" attributes="*">
