...
<cfcomponent output="false">
	...
	<cffunction name="sendSMSNew" returntype="string" output="true" access="remote">
	...
	<cffunction name="sendSMS" returntype="string" output="true" access="remote">
		<cfargument name="request" type="string" required="yes">
		<!---<cfargument name="text" type="string" required="yes">
	...
	<cffunction name="getUserSMS" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getUsersSMSSent" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getSMSes" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
