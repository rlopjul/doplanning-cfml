...
<cfcomponent output="false">
	...
	<cffunction name="connectToOrganizationConversation" returntype="xml" output="false" access="remote">		
	...
	<cffunction name="disconnectFromOrganizationConversation" returntype="xml" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getOrganizationConversationMessages" returntype="xml" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="acknowledgeOrganizationConversationMessages" returntype="xml" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getOrganizationConversationUsers" returntype="xml" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="sendOrganizationConversationMessage" returntype="xml" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
