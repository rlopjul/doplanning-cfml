...
<cfcomponent output="false">
	...
	<cffunction name="createConsultation" returntype="string" output="false" access="remote">		
	...
	<cffunction name="createConsultationWithAttachedFile" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="updateConsultation" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="updateConsultationWithAttachedFile" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="postConsultationToTwitter" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="selectConsultation" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="deleteConsultation" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getAreaConsultationsList" output="false" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getAreaConsultationsTree" output="false" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getConsultationFileStatus" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getConsultationImageStatus" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
