...
<cfcomponent output="false">
	...
	<cffunction name="createMessage" returntype="string" output="false" access="remote">		
	...
	<cffunction name="createMessageWithAttachedFile" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="selectMessage" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="deleteMessage" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
