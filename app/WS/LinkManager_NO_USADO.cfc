...
<cfcomponent output="false">
	...
	<cffunction name="createLink" returntype="string" output="false" access="remote">		
	...
	<cffunction name="createLinkWithAttachedFile" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="updateLink" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="updateLinkWithAttachedFile" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="postLinkToTwitter" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="selectLink" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="deleteLink" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<!--- ----------------GET AREA LINKS LIST---------------------------------------   --->
	<cffunction name="getAreaLinksList" output="false" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<!---<cffunction name="getAreaLinksTree" output="false" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getLinkFileStatus" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getLinkImageStatus" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
