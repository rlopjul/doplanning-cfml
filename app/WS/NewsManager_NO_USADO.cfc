...
<cfcomponent output="false">
	...
	<cffunction name="createNews" returntype="string" output="false" access="remote">		
	...
	<cffunction name="createNewsWithAttachedFile" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="updateNews" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="updateNewsWithAttachedFile" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="postNewsToTwitter" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="selectNews" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="deleteNews" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<!--- ----------------GET AREA NEWSS LIST---------------------------------------   --->
	<cffunction name="getAreaNewssList" output="false" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<!---<cffunction name="getAreaNewssTree" output="false" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getNewsFileStatus" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getNewsImageStatus" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
