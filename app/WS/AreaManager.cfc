...
<cfcomponent output="false">
	...
	<cffunction name="checkAreasAccessRemote" output="false" access="remote" returntype="String">		
	...
	<cffunction name="getAllUserAreasListRemote" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getMainTree" output="false" access="remote" returntype="string">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getMainTreeAdmin" access="remote" returntype="string">
		<cfargument name="request" type="string" required="yes">
		...
		<cftry>
			...
			<cfinclude template="includes/functionStart.cfm">
				...
				<cfset rootAreas = valueList(rootAreasQuery.id, ",")>
				
				<cfloop list="#rootAreas#" index="root_area_id">--->
				...
				<cfset xmlResponseContent = "<areas>#areasResult#</areas>">			
	...
	<cffunction name="createArea" output="false" access="remote" returntype="String">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="selectArea" output="false" access="remote" returntype="string">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="selectAreaAdmin" output="false" access="remote" returntype="string">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="deleteArea" output="false" access="remote" returntype="string">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="updateArea" returntype="string" output="false" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getAreaMessagesList" output="false" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<!---Esta función hay que quitarla de este componente ya que se debe usar directamente la de MessageManager, se mantiene aquí para mantener compatibilidad con la versión de cliente de Flex--->
	<cffunction name="getAreaMessagesTree" output="false" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getAreaMembers" output="false" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getAreaMembersAdmin" output="false" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<!---  --------------------GET AREA FILES-------------------------------------  --->
	<cffunction name="getAreaFiles" output="false" returntype="string" access="remote">
	...
	<cffunction name="getAreasAdministrators" output="false" returntype="string" access="remote">
	...
	<cffunction name="setAreaAdministrator" output="false" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="dissociateAreaAdministrator" output="false" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
		<!---<cfargument name="area_id" type="string" required="true">--->
	...
	<cffunction name="createAreaImage" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="selectAreaImage" returntype="string" access="remote">		
		<cfargument name="request" type="string" required="yes">
