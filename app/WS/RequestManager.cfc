...
<cfcomponent output="false">
	...
	<cffunction name="xmlRequest" access="public" returntype="xml">
		...
		<cftry>
			...
			<!---<cfmail subject="Request" server="#APPLICATION.emailServer#" username="#APPLICATION.emailServerUserName#" password="#APPLICATION.emailServerPassword#" from="#APPLICATION.emailFrom#" replyto="#APPLICATION.emailReply#" failto="#APPLICATION.emailFail#" to="#APPLICATION.emailErrors#">
				<cfoutput>
