...
<cfcomponent output="false">
	...
	<cfset component = "IframeDisplayTypeQuery">	
	...
	<cffunction name="getDisplayTypes" output="false" returntype="query" access="public">		
		...
		<cfset var method = "getDisplayTypes">
			...
			<cfquery name="displayTypesQuery" datasource="#client_dsn#">
				SELECT iframe_display_type_id, width, width_unit, height, height_unit,
				iframe_display_type_title_es, iframe_display_type_title_en
				FROM #client_abb#_iframes_display_types
				WHERE enabled = 1
				ORDER BY iframe_display_type_id ASC;
			</cfquery>	
