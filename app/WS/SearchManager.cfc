...
<cfcomponent output="false">
	...
	<cffunction name="searchFiles" returntype="string" output="false" access="remote">		
	...
	<cffunction name="searchMessages" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="searchUsers" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="searchAreas" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
