...
<cfcomponent output="false">
	...
	<cffunction name="createTask" returntype="string" output="false" access="remote">		
	...
	<cffunction name="createTaskWithAttachedFile" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="updateTask" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="updateTaskWithAttachedFile" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="postTaskToTwitter" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="selectTask" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="deleteTask" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<!--- ----------------GET AREA TASKS LIST---------------------------------------   --->
	<cffunction name="getAreaTasksList" output="false" returntype="string" access="remote">
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getTaskFileStatus" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="getTaskImageStatus" returntype="string" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
