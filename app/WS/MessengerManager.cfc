...
<cfcomponent output="false">
	...
	<cffunction name="getAllUsers" returntype="xml" output="false" access="remote">
	...
	<cffunction name="saveConversation" returntype="xml" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
	...
	<cffunction name="deleteConversation" returntype="xml" output="false" access="remote">		
		<cfargument name="request" type="string" required="yes">
